...
urlpatterns = [
    ...
    path(r'request_list/<relation_id>/', views.request_list, name='request_list'),
    path(r'booking_list/<relation_id>/', views.booking_list, name='booking_list'),
    ...
    path(r'child_booking_list/<relation_id>/', views.child_booking_list, name='child_booking_list'),
